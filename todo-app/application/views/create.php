...
<body>
    ...
    <div class="container" style="padding-top: 10px;">
        <form action="<?php echo base_url() . 'index.php/todo_user/create' ?>" method="post">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="todo_task_name" value="<?php echo set_value('todo_task_name'); ?>">
